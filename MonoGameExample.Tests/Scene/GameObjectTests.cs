...

{
    public class GameObjectTests
    {
        ...
        public void TestGameObjectUpdate()
        {
            ...
            var camera = new Camera(Vector3.Zero, Vector3.Forward, Vector3.Up);
            var graphicsDeviceWrapper = new Mock<IGraphicsDeviceWrapper>();

            // Act
            gameObject.Update(gameTime, camera, graphicsDeviceWrapper.Object);
        ...
        public void TestGameObjectChildUpdate()
        {
            ...
            // Act
            parent.Update(gameTime, camera, graphicsDeviceWrapper.Object);
